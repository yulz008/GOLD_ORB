...
input int StartOfTradingHour_ServerTime = 0;

input group  "Trade Management"
input int TakeProfit =1000;
input int StopLoss =500;
input int MaxTradePerDay =1;
...
input double MaxRiskPerTradePercent = 5;
...
//|      
//|  **MonitoringVirtualPosition - Monitoris and Closes virtual position 
